...
if(isset($_POST['submit']))
{
    ...
    file_put_contents('t1.txt', $search);
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a href="index.html"><img src="assets/img/hero-bg.png" height="50%" width="50%" alt="Klorofil Logo" class="img-responsive logo"></a>
                            <!-- <a class="navbar-brand" href="index.html">Amazon Review Analysis</a> -->
                            ...
                            <div class="col-md-10">
                                <form class="form-wrap mt-4" method="POST">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="text" placeholder="What are your looking for?" class="btn-group1" name="search" id="search">
                                        <!-- <input type="text" placeholder="New york" class="btn-group2"> -->
                                        <input type="submit" class="btn-form" name="submit" id="submit"><span class="icon-magnifier search-icon"></span><i class="pe-7s-angle-right"></i>
                                    </div>
                                </form>
