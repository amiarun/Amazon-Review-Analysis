...
if(isset($_POST['submit']))
{
	...
	$compo=$_POST['compo'];
	$file = fopen("aa.csv","a");
	$list=array($textarea,$compo);
	print_r($list);
	echo $textarea;
	echo $compo;
	fputcsv($file,$list);
	// fputcsv($file,array("$textarea","$compo"));
    fclose($file);
}
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="page-login.php"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
							</ul>
						</li>
						<!-- <li>
						...
						<div class="col-md-6">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<br>
									<input type="text"class="form-control" name="textarea" id="textarea" placeholder="textarea" rows="4">
									<br>
									<select class="form-control" name="compo" id="compo">
										<!-- <option value="cheese">Choose</option> -->
									...
									<br>
									<input type="submit" class="btn btn-success" name="submit" id="submit"><span class="icon-magnifier search-icon"></span><i class="pe-7s-angle-right"></i>
									<!-- <button type="button" class="btn btn-success">Success</button> -->
