  ...
  <body>
    <div class="s012">
      ...
      <!-- <a href="index.html"><img src="assets/img/hero-bg.png" height="50%" width="50%" alt="Klorofil Logo" class="img-responsive logo"></a> -->
        <fieldset>
        <legend>Compare Amazon Product</legend>
          ...
          <div class="main-form" id="main-form">
            <div class="row">
              <div class="input-wrap">
                ...
                <div class="input-field">
                  ...
                  <input type="text" placeholder="First Product URL"  name="search1" id="search1"/>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="input-wrap">
                ...
                <div class="input-field">
                  <!-- <label>GOING TO</label> -->
                  <input type="text" placeholder="Second Product URL"  name="search2" id="search2"/>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="input-wrap">
                ...
                <div class="input-field">
                  <!-- <label>GOING TO</label> -->
                  <input type="text" placeholder="Third Product URL"  name="search3" id="search3"/>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="input-wrap">
                ...
                <div class="input-field">
                  <!-- <label>GOING TO</label> -->
                  <input type="text" placeholder="Fourth Product URL"  name="search4" id="search4"/>
                </div>
              </div>
            </div>
            ...
            <div class="row last">
              <input type="submit" class="btn-search" value="Compare"  name="submit" id="submit">
            </div>
          </div>
        </div>
      </form>
