...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="assets/img/blackamazon.png" height="10%" width="10%" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="home/home.php"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
							</ul> 
						</li>
						<!-- <li>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<!-- <li><a href="page-login.php" class=""><i class="lnr lnr-file-empty"></i> <span>Login</span></a></li> -->
							...
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number">Improvise</span>
											<a href="elements.php" class="title"><b>DATASET</b></a></li>
										</p>
									</div>
								...
								<div class="col-md-3">
									<div class="metric">
										<span class="icon"><i class="fa fa-download"></i></span>
										<p>
											<span class="number">Train the</span>
											<a href="train.php" class="title"><b>MODEL</b></a></li>
										</p>
									</div>
