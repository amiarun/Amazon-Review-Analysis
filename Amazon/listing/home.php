...
if(isset($_POST['submit']))
{
    ...
    file_put_contents('c1.txt', $search1);
    file_put_contents('c2.txt', $search2);
    file_put_contents('c3.txt', $search3);
    file_put_contents('c4.txt', $search4);
    header('location:./web/compare.php');
}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.html">Amazon Comparitive Polarity</a>
                ...
                <span class="icon-menu"></span>
                    ...
                    <!-- <span class="icon-arrow-down"></span> -->
                                    ...
                                    <li class="nav-item active">
                                        ...
                                        <a href="page-login.php"><button type="submit"  id="signin" name="signin" class="btn btn-primary btn-lg btn-block">LOGIN</button></a>
                                    </li>
                                    <!-- <li class="nav-item">
                            ...
                            <div class="col-md-10">
                                <form class="form-wrap mt-4" method="POST">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="text" placeholder="Product URL" class="btn-group1" name="search1" id="search1">
                                        <input type="text" placeholder="Product URL" class="btn-group1" name="search2" id="search2">
                                        <input type="text" placeholder="Product URL" class="btn-group1" name="search3" id="search3">
                                        <input type="text" placeholder="Product URL" class="btn-group1" name="search4" id="search4">
                                        <!-- <input type="text" placeholder="New york" class="btn-group2"> -->
                                        <input type="submit" class="btn-form" name="submit" id="submit"><span class="icon-magnifier search-icon"></span>SEARCH<i class="pe-7s-angle-right"></i>
                                    </div>
                                </form>
                                <div class="slider-link">
                                    <!-- <a href="#" class="btn btn-danger">COMPARE</a> -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        ...
                        <p>Copyright &copy; 2020 Amazon product comparitive polarity Analysis. All rights reserved |Amitha Arun
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        <ul>
