...
Corpus = pd.read_csv(R"C:\xamppnew\htdocs\Amazon\listing\IMDB_train-bkup.csv",encoding='latin-1')
...
pickle.dump(Encoder, open(R'C:\xamppnew\htdocs\Amazon\listing\label.sav','wb'))
...
pickle.dump(Tfidf_vect, open(R'C:\xamppnew\htdocs\Amazon\listing\tfidf.sav', 'wb'))
...
pickle.dump(SVM, open(R'C:\xamppnew\htdocs\Amazon\listing\model_svm.sav', 'wb'))
